                    ...
                    <div class="col-md-4 h-100">
                        <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="row my-3">
                                        <div class="col-2">
                                            <a href="/profile/{{$comment->user->id}}">
                                                <img src="{{ asset($comment->user->profile->profileImage()) }}" class="rounded-circle w-100">
                                            </a>
                                        </div>
                                        <div class="col-10 pl-0">
                                            <p class="m-0 text-dark">
                                                <a href="/profile/{{$comment->user->id}}" class="my-0 text-dark text-decoration-none">
                            ...
                            <div class="card-footer align-self-end w-100 p-0 border-top-0">
                                ...
                                <!-- Add Comment -->
                                <form m action="{{ route('comment.add') }}" method="POST">
                                    @csrf
