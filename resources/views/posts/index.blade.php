        ...
        <div class="row justify-content-center">
                                ...
                                <div class="modal fade" id="post{{$post->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <ul class="list-group">
                                            ...
                                            @can('delete', $post)
                                                <form action="{{url()->action([App\Http\Controllers\PostsController::class, 'destroy'], $post->id)}}" method="POST">
                                                    @csrf
                                                    @method("DELETE")
                        ...
                        <div class="card-body px-3 py-2">
                            ...
                            <div class="flex-row">
                                ...
                                <p class="card-text mb-1">
                                    <a href="/profile/{{$post->user->id}}" class="my-0 text-dark text-decoration-none">
                ...
                @empty
                    ...
                    <div class="d-flex justify-content-center p-3 py-5 border bg-white">
                        <div class="card border-0 text-center">
                            <img src="{{asset('svg/nopost.png')}}" class="card-img-top" alt="..." style="max-width: 330px">
                            <div class="card-body ">
                                <h3>No Post found</h3>
            ...
            <aside class="aside col-md-4 py-3 ">
                <div class="position-fixed">
                    ...
                    <!-- Suggestions -->
                    <div class='mb-5 ' style="width: 300px   padding-right: ($spacer * .5) !important;
                    ">
                    ...
                    <!-- CopyRight -->
                    <div>
                        <span style='color: #a6b3be;'>© 2022 Inst</span>
                    </div>
